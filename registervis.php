...
<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: #e3f2fd;">
  ...
  <a href="registervis.php">About</a>
  <a href="registervis.php">Services</a>
  <a href="registervis.php">Municipalities</a>
  <a href="registervis.php">Admin</a>
  <a href="registervis.php">Feedback</a>
  </div>
</div><!--sidenav-->
...
<div class="container-fluid">
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 maincontent">
     ...
     <form name="registerForm" action="registerProcessvis.php" method="get" onsubmit="return validateForm()">
			<table align="center">
